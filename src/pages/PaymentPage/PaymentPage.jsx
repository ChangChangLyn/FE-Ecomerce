...
import InputComponent from "../../components/InputCompunent/Inputcomponent";
...
const PaymentPage = () => {
  ...
  return (
    <div style={{ background: "#f5f5fa", with: "100%", height: "100vh" }}>
      ...
      >
        <h3 style={{ fontWeight: "bold", paddingTop: "20px" }}>Thanh toán</h3>
        <div
          style={{
            display: "flex",
            ...
            <WrapperInfo>
              <div>
                ...
                <WrapperRadio onChange={handlePayment} value={payment}>
                  ...
                  <Radio value="paypal"> Thanh toán online bằng Paypal</Radio>
                </WrapperRadio>
              </div>
            </WrapperInfo>
          </WrapperLeft>
